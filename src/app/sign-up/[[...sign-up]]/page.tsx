    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 800, letterSpacing: "-0.02em" }}>Create your account</h1>
          <p style={{ color: "#94a3b8", fontSize: 14, marginTop: 4 }}>
            Start generating tailored project ideas for free
          </p>
        </div>
        ...
        <div style={{ textAlign: "center", marginTop: 22, fontSize: 13, color: "#94a3b8" }}>
          ...
          <Link href="/sign-in" style={{ color: "#60a5fa", textDecoration: "none", fontWeight: 600 }}>
            Sign in
          </Link>
        </div>
